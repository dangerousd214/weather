// 9b9e4004b93d04fa5c69b228cf3fed82 api key for weather
$(document).ready(function(){ 
    ...
    var apiKey = '9b9e4004b93d04fa5c69b228cf3fed82 ';
    ...
    function searchWeather(cities) {
        var wholeUrl = baseUrl + "q=" + cities + "&units=imperial" + "&appid=" + apiKey;
        fetch(wholeUrl)
  ...
  // 5 day forecast
    function searchForecast(cities) {
        var forecastBaseUrl2 = baseUrl2 + "q=" + cities + "&units=imperial" + "&appid=" + apiKey;
 ...
 //update at specific time and use moment for date
            for (var i = 0; i < data.list.length; i++) {
                ...
                if (timeThreeOClock > -1) {
                    ...
                    //create variables using specific api data
